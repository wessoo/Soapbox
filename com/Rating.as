package com {
	...
	public class Rating extends TouchComponent {
		...
		public function Rating() {
			...
			window_gotbadge.txt_name.alpha = window_gotbadge.txt_invalid.alpha = 0;
		...
		private function namebg_up(e:TouchEvent):void {
			var target_height:int = window_gotbadge.window_modal.height + 50;
			var target_ypos:int = window_gotbadge.window_modal.y - (target_height - window_gotbadge.window_modal.height)/2;
			
			//addChild(cont_es_exitKeyboard); //NEED TO ADD EXIT KEYBOARD?
			...
			Tweener.addTween(window_gotbadge.window_namebg, { y: window_gotbadge.window_namebg.y - 50, time: 1});
			Tweener.addTween(window_gotbadge.txt_name, { y: window_gotbadge.txt_name.y - 50, time: 1});
